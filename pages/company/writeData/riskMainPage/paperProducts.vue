<template>
	<view class="app_paper_products_container">
		<!-- 纸制品 -->
		...
		<view class="business_wrapper padding_10px">
			...
			<!--可燃性粉尘-->
			<combustible-dust :cmpData="dustData" :bool="change_bool"  v-if="currentIndex == 0" ref="page0" @changeNext="changeNext"></combustible-dust>
			<!--有限空间-->
			<limitedSpace-o :cmpData="spaceData" :bool="change_bool"  v-if="currentIndex == 1" ref="page1" @changeNext="changeNext" :spaceData="spaceData"></limitedSpace-o>
			<!--高温熔融-->
			<high :cmpData="highData" :bool="change_bool"  v-if="currentIndex == 2" ref="page2" @changeNext="changeNext"></high>
			<!-- 特殊作业及特种设备 -->
			<special-work-and-device-t :cmpData="workAndDevicData" :bool="change_bool"  v-if="currentIndex == 3" ref="page3" @changeNext="changeNext"></special-work-and-device-t>
			<!-- 危险化学品 -->
			<hazardous-chemicals :cmpData="hazardousChemicalsData" :bool="change_bool"  v-if="currentIndex == 4" ref="page4" @changeNext="changeNext"></hazardous-chemicals>
...
<script>
	...
	import high from '../riskPage/high.vue'
	...
	export default {
		data() {
			return {
				drawerVisible: false,
				currentIndex: 0,
				navData: ['可燃性粉尘', '有限空间', '高温熔融', '特殊作业及特种设备', '危险化学品'],
				spaceData: {},
				workAndDevicData: {},
				dustData: {},
