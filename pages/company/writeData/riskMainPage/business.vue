<template>
	<view class="app_business_container">
		...
		<view class="business_wrapper padding_10px">
			...
			<!-- 特殊作业及特种设备 -->
			<special-work-and-device-t :cmpData="workAndDevicData" :bool="change_bool" v-if="currentIndex == 2" ref="page2" @changeNext="changeNext"></special-work-and-device-t>
			<!-- 危险化学品 -->
			<hazardous-chemicals :cmpData="hazardousChemicalsData" :bool="change_bool" v-if="currentIndex == 3" ref="page3" @changeNext="changeNext"></hazardous-chemicals>
