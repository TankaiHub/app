<template>
	<view class="app_industry_furniture_container">
		<!-- 轻工 家具 -->
		...
		<view class="business_wrapper padding_10px">
			...
			<!-- 有限空间 -->
			<limited-space-o :cmpData="spaceData" :bool="change_bool" v-if="currentIndex == 1" ref="page1" @changeNext="changeNext"></limited-space-o>
