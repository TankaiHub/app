<template>
	<view class="app_industry_furniture_container">
		...
		<view class="business_wrapper padding_10px">
			...
			<!-- 有限空间 -->
			<limited-space-o v-if="currentIndex == 1" ref="page1" @changeNext="changeNext"></limited-space-o>
			
			<!-- 高温熔融 -->
			<high v-if="currentIndex == 2" ref="page2" @changeNext="changeNext"></high> 
			
			<!-- 特殊作业及特种设备 -->
			<special-work-and-device-t v-if="currentIndex == 3" ref="page3" @changeNext="changeNext"></special-work-and-device-t>
			
			<!-- 危险化学品 -->
			<hazardous-chemicals v-if="currentIndex == 4" ref="page4" @changeNext="changeNext"></hazardous-chemicals>
