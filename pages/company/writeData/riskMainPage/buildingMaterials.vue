<template>
	<view class="app_building_materials_container">
		<!-- 建材 -->
		...
		<view class="business_wrapper padding_10px">
			...
			<!-- 有限空间 -->
			<limitedSpace-t v-if="currentIndex == 1" ref="page1" @changeNext="changeNext" :cmpData="spaceData"  :bool="change_bool"></limitedSpace-t>
			<!-- 特殊作业及特种设备 -->
			<special-work-and-device v-if="currentIndex == 2" :cmpData="workAndDevicData" :bool="change_bool" ref="page2" @changeNext="changeNext"></special-work-and-device>
			<!-- 危险化学品 -->
...
<script>
	...
	import limitedSpaceT from '../riskPage/limitedSpace-t.vue'
