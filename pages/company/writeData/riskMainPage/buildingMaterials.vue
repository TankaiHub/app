<template>
	<view class="app_building_materials_container">
		...
		<view class="business_wrapper padding_10px">
			...
			<!-- 有限空间 -->
			<limitedSpace-t v-if="currentIndex == 1" ref="page1" @changeNext="changeNext" :spaceData="spaceData"></limitedSpace-t>
			<!-- 特殊作业及特种设备 -->
			<special-work-and-device v-if="currentIndex == 2" ref="page2" @changeNext="changeNext"></special-work-and-device>
			<!-- 危险化学品 -->
