<template>
	<view class="evan-step" :class="'evan-step--'+direction">
		...
		<view class="evan-step__content" :class="'evan-step__content--'+direction" :style="{height:contentHeight}">
			<text ref="content" class="evan-step__content__title" :class="'evan-step__content__title--'+direction" :style="{color:titleColor}">
				{{title}}
				<text class="evan_step_c_t" @click="onChange">{{ changeText }}</text>
			</text>
